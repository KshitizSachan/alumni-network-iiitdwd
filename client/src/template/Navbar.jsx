...
const Navbar = () => {
  ...
  const buttonStyle1 =
    "cursor-pointer hover:bg-primaryPink hover:text-white rounded-full px-3 flex items-center py-1 mx-1";
  const buttonStyle2 =
    "cursor-pointer bg-primaryPink text-white rounded-full px-3 flex items-center py-1 mx-1";
