...
const Profile = () => {
  return (
    <>
      ...
      <div className="relative">
        <div className="absolute -top-16 sm:-top-20 lg:-top-32 left-6 sm:left-14 xl:left-28 overflow-hidden rounded-full size-32 sm:size-40 lg:size-52 xl:size-60">
          <img src="/rnd.jpg" alt="profile-img" className="w-full object-cover" />
        </div>
      </div>
      <div className="flex flex-col md:flex-row">
        <div className="flex flex-col justify-center items-center pt-40 md:w-[37%] bg-[#d9d9d9]/40 gap-16 px-8">
        ...
        <div className="flex flex-col px-8 py-6 bg-primaryBackground md:w-[63%]">
